...
# Passou raspando no teste de normalidade p-valor > 0.05 
...
### Passou no teste de normalidade ao nível de significância de 5%
...
```
## Não passou no teste de normalidade dos resíduos
- para um modelo de regressão não estaria correto, pois não atende a normalidade dos resíduos.
- por outro lado os valores de qualidade e acurácia são bem melhores.
- como modelo para uso em machine learning seria interessante testá-lo em produção, mas como modelo estatístico o criado por step wise seria melhor por atender aos pressupostos estatísticos.
